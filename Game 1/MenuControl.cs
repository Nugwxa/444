...
public class MenuControl : MonoBehaviour
{
    ...
    public void StartDigitSpan() 
     {
     //if the user attempts to play the digit span mode and they have played 5 times, inform them that they have reached their max attempts. else start the digit span mode
        if (DigitSpanAttempts = 5)
        {
    ...
    {
    //if the user attempts to play the spatial span mode and they have played 5 times, inform them that they have reached their max attempts. else start the spatial span mode
        if (SpatialSpanAttempts > 4)
        {
            MaxAttempts.SetActive(true);
        }
        else
    ...
    public void Reset() //Resets number of attempts
    {
